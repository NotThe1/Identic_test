...
//		sm.pickButton(1);
	...
	private void appClose() {
		Preferences myPrefs =  Preferences.userNodeForPackage(SideMenu_Driver.class).node(this.getClass().getSimpleName());
...
//		
		buttons = new JButton[]{btnFindDups,btnDisplayResults,btnFindDuplicatesByName,btnCopyMoveRemove,btnFileTypes};
